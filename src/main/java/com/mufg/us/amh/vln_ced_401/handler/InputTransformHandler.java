...
public class InputTransformHandler {
	...
	public RequestData unmarshallingDocument(String payload) throws JAXBException {
		log.info("InputTransformHandler :: unmarshallingDocument() :: Init ");
		...
		log.info("InputTransformHandler :: unmarshallingDocument() :: Ends ");
		return je.getValue();
	}
