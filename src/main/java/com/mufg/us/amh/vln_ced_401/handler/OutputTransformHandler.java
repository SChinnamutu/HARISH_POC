...
public class OutputTransformHandler {
	...
	public String marshallingDocument(RequestData unMarshalDocument, String processId) throws JAXBException {
		log.info("OutputTransformHandler :: marshallingDocument() :: Init " + processId);
        ...
        log.info("OutputTransformHandler :: marshallingDocument() :: Ends "+ processId);
		return response;
	}
	...
	private void prepareFileHeader(RequestData unMarshalDocument,TransmissionData outboundDocument) {
		...
		Information.setSystemName(!StringUtils.isEmpty(FLDS.get(0).getValue()) ? FLDS.get(0).getValue() : null );
	...
	private void prepareCustomerHeader(RequestData unMarshalDocument, OutputAreaGRP areaGRP) {
		...
		contactDetails.setCustomerName(!StringUtils.isEmpty(CUSTOMER_FLDS.get(1).getValue()) ? CUSTOMER_FLDS.get(1).getValue().trim() : null );
		contactDetails.setAttention(!StringUtils.isEmpty(CUSTOMER_FLDS.get(2).getValue()) ? CUSTOMER_FLDS.get(2).getValue() : null );
		...
		contactDetails.setPrimaryFaxCountryCode(!StringUtils.isEmpty(CUSTOMER_FLDS.get(5).getValue()) ? CUSTOMER_FLDS.get(5).getValue() : null );
		contactDetails.setPrimaryFax(!StringUtils.isEmpty(CUSTOMER_FLDS.get(6).getValue()) ? CUSTOMER_FLDS.get(6).getValue() : null );
		contactDetails.setSecondaryFaxCountryCode(!StringUtils.isEmpty(CUSTOMER_FLDS.get(7).getValue()) ? CUSTOMER_FLDS.get(7).getValue() : null );
		contactDetails.setSecondaryFax(!StringUtils.isEmpty(CUSTOMER_FLDS.get(8).getValue()) ? CUSTOMER_FLDS.get(8).getValue() : null );
		contactDetails.setCopyFax1CountryCode(!StringUtils.isEmpty(CUSTOMER_FLDS.get(9).getValue()) ? CUSTOMER_FLDS.get(9).getValue() : null );
		contactDetails.setCopyFax1(!StringUtils.isEmpty(CUSTOMER_FLDS.get(10).getValue()) ? CUSTOMER_FLDS.get(10).getValue() : null );
		contactDetails.setCopyFax2CountryCode(!StringUtils.isEmpty(CUSTOMER_FLDS.get(11).getValue()) ? CUSTOMER_FLDS.get(11).getValue() : null );
		contactDetails.setCopyFax2(!StringUtils.isEmpty(CUSTOMER_FLDS.get(12).getValue()) ? CUSTOMER_FLDS.get(12).getValue() : null );
		contactDetails.setContactAddress1(!StringUtils.isEmpty(CUSTOMER_FLDS.get(13).getValue()) ? CUSTOMER_FLDS.get(13).getValue().replaceAll("\\s+","") : null );
		contactDetails.setContactAddress2(!StringUtils.isEmpty(CUSTOMER_FLDS.get(14).getValue()) ? CUSTOMER_FLDS.get(14).getValue().replaceAll("\\s+","") : null );
		contactDetails.setContactAddress3(!StringUtils.isEmpty(CUSTOMER_FLDS.get(15).getValue()) ? CUSTOMER_FLDS.get(15).getValue() : null );
		contactDetails.setContactAddress4(!StringUtils.isEmpty(CUSTOMER_FLDS.get(16).getValue()) ? CUSTOMER_FLDS.get(16).getValue() : null );
		contactDetails.setCity(!StringUtils.isEmpty(CUSTOMER_FLDS.get(17).getValue()) ? CUSTOMER_FLDS.get(17).getValue().replaceAll("\\s+","") : null );
	...
	private void prepareSearchKey(RequestData unMarshalDocument, OutputAreaGRP areaGRP) {
		...
		searchFields.setTransactionNumber(!StringUtils.isEmpty(SEARCH_FLDS.get(3).getValue()) ? SEARCH_FLDS.get(3).getValue() : null );
		searchFields.setCurrentOustandingAmount(!StringUtils.isEmpty(SEARCH_FLDS.get(4).getValue()) ? SEARCH_FLDS.get(4).getValue() : null );
